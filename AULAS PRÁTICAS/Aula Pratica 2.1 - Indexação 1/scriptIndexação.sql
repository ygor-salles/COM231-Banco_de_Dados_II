...
(enum_range(NULL::sexo_t))[floor(random() * (2-1 + 1) + 1)],
 date(timestamp '1990-01-01' + random() * (timestamp '1990-12-31' -
...
SELECT ctid, * FROM funcionario;
SELECT * FROM pg_indexes WHERE tablename = 'funcionario';

--QUESTÃO 5
EXPLAIN ANALYSE SELECT * FROM funcionario;
...
--QUESTÃO 7D
CREATE INDEX func_sexo_depto ON funcionario USING btree (sexo, depto);
